...
final class ArrayViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        operationsCollectionView.register(UINib(nibName: Constants.arrayOperationCellReuseID, bundle: nil), forCellWithReuseIdentifier: Constants.arrayOperationCellReuseID)
    }
...
extension ArrayViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constants.arrayOperationCellReuseID, for: indexPath) as? ArrayOperationCell else { return UICollectionViewCell() }
...
extension ArrayViewController: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        guard let cell = collectionView.cellForItem(at: indexPath) as? ArrayOperationCell,
